...
class SelectEventLocationScreen extends StatefulWidget {
  final LatLng? initialLocation;
  final String? initialLocationName;

  const SelectEventLocationScreen({
    super.key,
  ...
  @override
  State<SelectEventLocationScreen> createState() =>
      _SelectEventLocationScreenState();
}

class _SelectEventLocationScreenState extends State<SelectEventLocationScreen> {
  ...
  void initState() {
    ...
    // Set initial selected location and name if provided
