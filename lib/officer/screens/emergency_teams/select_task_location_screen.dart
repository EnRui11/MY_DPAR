...
class SelectTaskLocationScreen extends StatefulWidget {
  final LatLng?
      initialLocation; // Optional initial location from ReportIncidentScreen

  const SelectTaskLocationScreen({super.key, this.initialLocation});

  @override
  State<SelectTaskLocationScreen> createState() =>
      _SelectTaskLocationScreenState();
}

class _SelectTaskLocationScreenState extends State<SelectTaskLocationScreen> {
