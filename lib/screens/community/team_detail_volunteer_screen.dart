...
class TeamDetailVolunteerScreen extends StatefulWidget {
  final String teamId;
  final bool isLeader;

  const TeamDetailVolunteerScreen({
    super.key,
  ...
  @override
  State<TeamDetailVolunteerScreen> createState() =>
      _TeamDetailVolunteerScreenState();
}

class _TeamDetailVolunteerScreenState extends State<TeamDetailVolunteerScreen>
                              ...
                              children: [
                                ...
                                Wrap(
                                  children: [
                                    ...
                                    else if (!isLeader && !isOfficialTeam) ...[
