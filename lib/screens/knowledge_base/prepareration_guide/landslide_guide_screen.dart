...
const _guideSections = [
  GuideSection(
    titleKey: 'before_landslide',
    cards: [
      GuideCardData(
        icon: Icons.remove_red_eye,
        titleKey: 'warning_signs',
        itemKeys: [
          'cracks_bulges',
          'tilting_trees',
          'unusual_sounds',
  ...
  GuideSection(
    ...
    cards: [
      ...
      GuideCardData(
        ...
        titleKey: 'evacuation_tips',
        itemKeys: [
          'use_designated_routes',
          'avoid_rivers',
          'watch_power_lines',
          'stay_clear_zones',
        ],
  ...
  GuideSection(
    titleKey: 'after_landslide',
    cards: [
      GuideCardData(
        icon: Icons.check_circle_outline,
        titleKey: 'safety_check',
        itemKeys: [
          'wait_all_clear',
          'report_trapped',
          'check_utilities',
      ...
      GuideCardData(
        ...
        titleKey: 'recovery_steps',
        itemKeys: [
          'photograph_damage',
          'avoid_damaged_buildings',
          'replant_vegetation',
          'seek_help',
        ],
      ),
...
const _emergencyContacts = [
  ...
  EmergencyContact(
    ...
    descriptionKey: 'report_power_lines',
  ),
];
...
class _Header extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return Container(
      ...
      padding: const EdgeInsets.all(LandslideGuideScreen._paddingValue),
      child: Row(
        children: [
          IconButton(
          ...
          const SizedBox(width: LandslideGuideScreen._spacingSmall),
          Text(
            l.translate('landslide_safety_guide'),
        ...
        children: [
          Row(
            children: [
              ...
              const SizedBox(width: LandslideGuideScreen._spacingSmall),
              Text(
                l.translate('landslide_warning'),
                style: TextStyle(color: colors.bg100, fontWeight: FontWeight.bold),
              ),
            ],
          ),
          const SizedBox(height: LandslideGuideScreen._spacingSmall),
          Text(
            l.translate('landslide_action'),
...
class _Section extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    final l = AppLocalizations.of(context);
    return Padding(
      padding: const EdgeInsets.only(bottom: LandslideGuideScreen._paddingValue),
      child: Column(
        crossAxisAlignment: CrossAxisAlignment.start,
        children: [
          Text(
          ...
          const SizedBox(height: LandslideGuideScreen._spacingMedium),
...
class _GuideCard extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    final l = AppLocalizations.of(context);
    return Container(
      margin: const EdgeInsets.only(bottom: LandslideGuideScreen._spacingMedium),
      ...
      child: Column(
        ...
        children: [
          ...
          ...card.itemKeys.map(
                (itemKey) => Padding(
              padding: const EdgeInsets.only(bottom: LandslideGuideScreen._spacingSmall),
              child: Row(
                crossAxisAlignment: CrossAxisAlignment.start,
                children: [
        ...
        children: [
          Row(
            children: [
              ...
              const SizedBox(width: LandslideGuideScreen._spacingSmall),
              Text(
                l.translate('Emergency Contacts'),
                style: TextStyle(fontSize: 18, fontWeight: FontWeight.w600, color: colors.primary300),
              ),
            ],
          ),
          ...
          child: Padding(
            ...
            child: Row(
              children: [
                ...
                const SizedBox(width: LandslideGuideScreen._spacingMedium),
                Expanded(
                  child: Column(
                    crossAxisAlignment: CrossAxisAlignment.start,
                    children: [
  ...
  void _showSnackBar(BuildContext context, String message, Color backgroundColor) {
    ScaffoldMessenger.of(context).showSnackBar(
      SnackBar(
        ...
        margin: const EdgeInsets.all(LandslideGuideScreen._paddingValue),
