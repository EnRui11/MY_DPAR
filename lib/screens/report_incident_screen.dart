  ...
  Future<void> _getCurrentLocation() async {
    ...
    try {
      ...
      setState(() {
        ...
        _mapController.move(_currentLocation ?? _defaultLocation, 15);
      });
    } catch (e) {
        ...
        child: Padding(
          ...
          child: ElevatedButton(
            ...
            style: ElevatedButton.styleFrom(
              backgroundColor:
              isSelected ? colors.accent200 : colors.bg100.withOpacity(0.7),
            ...
            children: [
              if (_isLoadingLocation)
                ...
                FlutterMap(
                  ...
                  options: MapOptions(
                    center:
                    _selectedMapLocation ?? _currentLocation ?? _defaultLocation,
                    zoom: 15,
                  ),
                  children: [
                    TileLayer(
