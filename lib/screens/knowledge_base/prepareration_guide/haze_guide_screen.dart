...
const _guideSections = [
    ...
    cards: [
      GuideCardData(
        ...
        itemKeys: [
          'stock_n95_masks',
          'seal_windows_doors',
          'prepare_air_purifiers',
          'plan_stay_relatives',
        ],
      ),
      GuideCardData(
        icon: Icons.favorite,
        titleKey: 'health_check',
        itemKeys: [
          'visit_clinic',
          'stock_inhalers',
          'know_nearest_clinic',
  ...
  GuideSection(
    titleKey: 'during_haze',
    cards: [
      GuideCardData(
        icon: Icons.shield,
        titleKey: 'protection_measures',
        itemKeys: [
          'stay_indoors_api_100',
          'wear_n95_masks',
  ...
  GuideSection(
    titleKey: 'api_levels_guide',
    cards: [
      GuideCardData(
        icon: Icons.show_chart,
        titleKey: 'activity_guidelines',
        itemKeys: [
          'api_0_50',
          'api_51_100',
          'api_101_200',
...
const _emergencyContacts = [
  ...
  EmergencyContact(
    labelKey: 'doe_hotline',
    number: '1-800-88-2727',
    icon: Icons.support_agent,
    descriptionKey: 'department_environment',
  ),
  EmergencyContact(
...
class _Header extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return Container(
      ...
      padding: const EdgeInsets.all(HazeGuideScreen._paddingValue),
      child: Row(
        children: [
          IconButton(
          ...
          const SizedBox(width: HazeGuideScreen._spacingSmall),
          Text(
            l.translate('haze_safety_guide'),
        ...
        children: [
          Row(
            children: [
              ...
              const SizedBox(width: HazeGuideScreen._spacingSmall),
              Text(
                l.translate('haze_warning'),
                style: TextStyle(color: colors.bg100, fontWeight: FontWeight.bold),
              ),
            ],
          ),
          const SizedBox(height: HazeGuideScreen._spacingSmall),
          Text(
            l.translate('haze_api_warning'),
...
class _Section extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    final l = AppLocalizations.of(context);
    return Padding(
      padding: const EdgeInsets.only(bottom: HazeGuideScreen._paddingValue),
      child: Column(
        crossAxisAlignment: CrossAxisAlignment.start,
        children: [
          Text(
          ...
          const SizedBox(height: HazeGuideScreen._spacingMedium),
...
class _GuideCard extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    final l = AppLocalizations.of(context);
    return Container(
      margin: const EdgeInsets.only(bottom: HazeGuideScreen._spacingMedium),
      ...
      child: Column(
        ...
        children: [
          ...
          ...card.itemKeys.map(
                (itemKey) => Padding(
              padding: const EdgeInsets.only(bottom: HazeGuideScreen._spacingSmall),
              child: Row(
                crossAxisAlignment: CrossAxisAlignment.start,
                children: [
          ...
          child: Padding(
            ...
            child: Row(
              children: [
                ...
                const SizedBox(width: HazeGuideScreen._spacingMedium),
                Expanded(
                  child: Column(
                    crossAxisAlignment: CrossAxisAlignment.start,
                    children: [
  ...
  void _showSnackBar(BuildContext context, String message, Color backgroundColor) {
    ScaffoldMessenger.of(context).showSnackBar(
      SnackBar(
        ...
        margin: const EdgeInsets.all(HazeGuideScreen._paddingValue),
